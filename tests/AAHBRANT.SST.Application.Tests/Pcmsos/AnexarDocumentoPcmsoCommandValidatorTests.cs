...
public class AnexarDocumentoPcmsoCommandValidatorTests
{
    ...
    public void Validate_ConteudoMaiorQue20Mb_RetornaErro()
    {
        ...
        Assert.Contains(resultado.Errors, e => e.PropertyName == nameof(AnexarDocumentoPcmsoCommand.Conteudo));
    }
    ...
    public void Validate_ContentTypeDiferenteDePdf_RetornaErro()
    {
        ...
        Assert.Contains(resultado.Errors, e => e.PropertyName == nameof(AnexarDocumentoPcmsoCommand.ContentType));
    }
