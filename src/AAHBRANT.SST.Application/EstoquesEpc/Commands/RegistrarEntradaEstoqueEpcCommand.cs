...
// Entrada manual de estoque (compra/reposição) numa Obra — cria a linha de EstoqueEpc se ainda não
// existir. Sem dimensão de Tamanho (diferente de RegistrarEntradaEstoqueUniformeCommand): EPC não
// é uma peça vestível.
