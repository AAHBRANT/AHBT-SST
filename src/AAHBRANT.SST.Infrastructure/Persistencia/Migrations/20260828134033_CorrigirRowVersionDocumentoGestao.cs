...
namespace AAHBRANT.SST.Infrastructure.Persistencia.Migrations
{
    ...
    public partial class CorrigirRowVersionDocumentoGestao : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "RowVersion", table: "DocumentosGestao");
            migrationBuilder.AddColumn<byte[]>(name: "RowVersion", table: "DocumentosGestao", type: "rowversion", rowVersion: true, nullable: true);
        }
