...
// modelo institucional oficial (AHBT-FIC-SSO-XXX-00_FichaEntregaEPI, seção 2). Extraído para cá
// (antes vivia só em AssinaturaEntregaEpiDialog.tsx) para ser compartilhado com
