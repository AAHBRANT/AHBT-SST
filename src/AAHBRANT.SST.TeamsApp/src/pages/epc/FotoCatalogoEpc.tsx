...
// Miniatura da foto do item de EPC — mesmo padrão de FotoCatalogoEpi.tsx/FotoCatalogoUniforme.tsx.
// O binário nunca vem embutido no CatalogoEpcDto (só o flag temFoto); baixa sob demanda via
// api.catalogosEpc.baixarFoto e mostra um placeholder (sem quebrar layout) quando não há foto ainda.
export function FotoCatalogoEpc({ catalogoEpcId, temFoto, tamanho = 48 }: FotoCatalogoEpcProps) {
  ...
  if (url) {
    return <img src={url} alt="Foto do item de EPC" style={{ ...estiloBase, objectFit: 'cover' as const }} />;
  }
