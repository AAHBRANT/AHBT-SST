...
// Módulo CIPA (NR-5, requisito do usuário, 31/08/2026), dentro do pilar Operação. Disclosure
// completo (dimensionamento sempre manual, apuração manual sem urna digital, PGR/GRO integrado
// via botão "Gerar Não Conformidade" e não automaticamente) em Domain/Entidades/Cipa/Cipa.cs.
